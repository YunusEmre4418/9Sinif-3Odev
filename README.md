...
Yukarıdaki örneği kullanarak **kendi ölçümlerinizle** bir tablo oluşturun (hiç değilse birkaç frame benim ölçümlerinden farklı olsun.) Kullandığınız Google Sheet için [buraya](https://docs.google.com/spreadsheets/d/1q7iZDwsKHGd_p4V7FE2buNsZRGUZ831Qqvvpu25Tyw0/edit?usp=sharing) link verin (Google Sheet herkese açık erişimli olsun.) 

a) Denkleminizi **x=4,48E-03+1,8t-1,21t^2**. Sizce a, b, ve c'nin fiziksel anlamları ne olabilir?a hızın değişimini gösterir, b ivme, c'yi bilmiyorum. Sizce niçin a'nın değeri negatif? Çünkü cisim yavaşlamaktadır.
b) Hava sürtünmesini ihmal edersek, bu harakette ivme sabit midir? Hayır, değildir.
c) Video'daki cismin atılış hızı farklı olsaydı (diğer herşey aynı, kütle, yüzey, vb. Hava sürtünmesini ihmal edin), sizce formülde hangi terimler değişecekti? (a, b veya c) Yalnızca a.
...
1) Kendi aldığınız verileri kullanarak **ortalama hız-zaman** grafiğini Google çiziniz. [Buraya](https://docs.google.com/spreadsheets/d/10sSP13gjSc_eSGGfuWjKAnTzvDKMKa0pQQ-v50ZbPkM/edit?usp=sharing) link veriniz.
...
3) İvme'yi ne buldunuz? Bu ivme değerini kullanarak 1kg'lık cisim ile yüzey arasındaki kinetik sürtünme katsayısını bulunuz. İvmeyi -2,72 buldum ama sürtünme katsayısını maalesef bulamadım.
...
Hocam bence siz en doğrusunu yapmışsınızdır.
...
Ben sürtünme katsayısını ivme ile bile bulamadım.
